    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=14, null=True, validators=[src.core.models.phone_number_null_or_validator])),
                ('user_type', models.CharField(choices=[('administration', 'Administration'), ('client', 'Client')], default='client', max_length=50)),
